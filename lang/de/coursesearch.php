...
$string['defaultgrouped'] = 'Ergebnisse standardmäßig nach Abschnitten gruppieren';
$string['defaultgrouped_desc'] = 'Die Darstellung der Ergebnisse, wenn das Widget einen Kurs ohne die Aktivität „Kurssuche“ durchsucht. Aktivitäten verwenden immer ihre eigene Einstellung „Ergebnisse nach Abschnitten gruppieren“; neue Aktivitäten übernehmen diesen Wert als Voreinstellung.';
$string['defaultplaceholder'] = 'Diesen Kurs durchsuchen...';
$string['description'] = 'Beschreibung';
$string['disabledmodules'] = 'Widget in diesen Aktivitäten ausblenden';
$string['disabledmodules_desc'] = 'Aktivitätstypen, auf deren Seiten das Schnellzugriffs-Widget nicht angezeigt wird. Wählen Sie zum Beispiel „Test“, damit das Widget während eines Testversuchs nicht erscheint, wo eine Suche im gesamten Kurs unerwünscht sein kann. Dies betrifft nur die Seiten von Aktivitäten – auf der Kursseite selbst wird das Widget weiterhin angezeigt.';
...
$string['floatingwidgetscope'] = 'Widget anzeigen in';
$string['floatingwidgetscope:allcourses'] = 'Allen Kursen';
$string['floatingwidgetscope:withactivity'] = 'Kursen mit der Aktivität „Kurssuche“';
$string['floatingwidgetscope_desc'] = 'Legt fest, wo das Schnellzugriffs-Widget erscheint. Bei „Kursen mit der Aktivität Kurssuche“ wird es nur in Kursen angezeigt, in denen Trainer/innen die Aktivität hinzugefügt haben, und verwendet deren Einstellungen. Bei „Allen Kursen“ erscheint es auch in Kursen ohne diese Aktivität und erlaubt es, diesen Kurs direkt zu durchsuchen.';
...
$string['searchcourse'] = 'Kurs durchsuchen';
...
$string['settingsdisplay'] = 'Anzeige der Ergebnisse';
$string['settingshighlighting'] = 'Hervorhebung';
$string['settingswidget'] = 'Schnellzugriffs-Widget';
$string['sitewidesearchdisabled'] = 'Die Suche in allen Kursen ist auf dieser Website nicht aktiviert.';
