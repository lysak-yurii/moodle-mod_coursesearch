...
$string['disabledmodules'] = 'Hide the widget in these activities';
$string['disabledmodules_desc'] = 'Activity types whose pages never show the quick-access widget. Selecting "Quiz", for example, keeps the widget off quiz attempt pages, where searching the course during an attempt may be undesirable. This applies to activity pages only - the widget still appears on the course page itself.';
