...
$string['disabledmodules'] = 'Приховувати віджет на цих сторінках';
$string['disabledmodules:coursepage'] = 'Сторінка курсу';
$string['disabledmodules_desc'] = 'Сторінки, на яких віджет швидкого доступу не показується: сама сторінка курсу та сторінки вибраних типів діяльностей. Наприклад, виберіть «Тест», щоб віджет не з\'являвся під час спроби тесту, де пошук по всьому курсу може бути небажаним.';
