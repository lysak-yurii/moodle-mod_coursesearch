...
$plugin->version   = 2026010602;       // The current module version (Date: YYYYMMDDXX).
...
$plugin->release   = '1.2.2';          // Version 1.2.2 - fixed HTML tag matching bug and added configurable placeholder filtering.
