...
$string['maxoccurrences_desc'] = 'Максимальна кількість входжень, які будуть знайдені на елемент контенту, коли пошуковий термін з\'являється кілька разів. Встановіть 0, щоб вимкнути обмеження та знайти всі входження (не рекомендується для великих курсів, оскільки це може вплинути на продуктивність та створити перевантажені списки результатів). За замовчуванням: 5.';
