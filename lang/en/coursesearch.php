...
$string['defaultgrouped'] = 'Group results by section by default';
$string['defaultgrouped_desc'] = 'The result layout used when the widget searches a course that has no Course Search activity. Activities always use their own "Group results by section" setting, and new activities start from this value.';
$string['defaultplaceholder'] = 'Search this course...';
$string['description'] = 'description';
$string['disabledmodules'] = 'Hide the widget on these pages';
$string['disabledmodules:coursepage'] = 'Course page';
$string['disabledmodules_desc'] = 'Pages that never show the quick-access widget: the course page itself and the pages of the selected activity types. Selecting "Quiz", for example, keeps the widget off quiz attempt pages, where searching the course during an attempt may be undesirable.';
...
$string['floatingwidgetscope'] = 'Show the widget in';
$string['floatingwidgetscope:allcourses'] = 'All courses';
$string['floatingwidgetscope:withactivity'] = 'Courses with a Course Search activity';
$string['floatingwidgetscope_desc'] = 'Where the quick-access widget appears. With "Courses with a Course Search activity" it is shown only in courses where a teacher has added the activity, and it uses that activity settings. With "All courses" it also appears in courses without the activity and lets users search that course directly.';
...
$string['settingsdisplay'] = 'Results display';
$string['settingshighlighting'] = 'Highlighting';
$string['settingswidget'] = 'Quick-access widget';
$string['sitewidesearchdisabled'] = 'Search in all courses is not enabled on this site.';
